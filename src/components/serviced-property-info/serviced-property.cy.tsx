import { ServicedPropertyComponent } from './serviced-property';

describe('ServicedPropertyComponent', () => {
  beforeEach(() => {
    ...
    cy.mount(<ServicedPropertyComponent />);
  });

  it('renders the main heading and subheading', () => {
    // Check if the main heading is rendered
    cy.contains('h1', 'Why serviced properties?').should('be.visible');
